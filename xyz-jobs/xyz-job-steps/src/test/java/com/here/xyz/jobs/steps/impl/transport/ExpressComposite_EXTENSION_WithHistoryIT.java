 ...
 * {@code com.here.xyz.test.featurewriter.sql.composite.history.SQLComposite_EXTENSION_WithHistoryTestSuiteIT}
 * against the express import writer.
 */
public class ExpressComposite_EXTENSION_WithHistoryIT extends ExpressTestSuite {
  ...
  /*
   * NOTE: SQLComposite_EXTENSION_WithHistoryTestSuiteIT does not declare own scenarios, it inherits them from the
