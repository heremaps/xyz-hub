...
public class Database extends ExecutionResource {
  private static final List<String> DEFAULT_SEARCH_PATH = List.of("common", "feature_writer", "transport", "s3_import", "s3_export"); //TODO: Replace with generated ones by Script tool, once scripts are installed by Step Lambda
