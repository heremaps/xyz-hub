...
import com.here.xyz.IoEventProcessor;
...
public abstract class PSQLAbstractIT extends Helper {
  ...
  protected static NPsqlConnectorParams connectorParams;

  protected static DataSource dataSource() {
    assert connectorParams != null;
    return NPsqlPool.get(connectorParams.getDbConfig()).dataSource;
  }
  ...
  protected static void initEnv(Map<String, Object> connectorParameters) throws Exception {
    ...
    connectorParams = new NPsqlConnectorParams(connectorParameters, "IntegrationTest");
  ...
  protected String invokeLambdaFromFile(String file) throws Exception {
    ...
    final IoEventProcessor<PsqlEventProcessor> eventContext = new IoEventProcessor<>(new PsqlEventProcessor());
