...
public class DatabaseStreamWriter extends DatabaseWriter{
    ...
    protected static FeatureCollection insertFeatures(@NotNull PsqlEventHandler processor, FeatureCollection collection,
    ...
    protected static FeatureCollection updateFeatures(@NotNull PsqlEventHandler processor, FeatureCollection collection,
        List<FeatureCollection.ModificationFailure> fails,
