...
public class DatabaseTransactionalWriter extends  DatabaseWriter{
    ...
    public static FeatureCollection insertFeatures(@NotNull PsqlEventHandler processor,
    ...
    public static FeatureCollection updateFeatures(@NotNull PsqlEventHandler processor, FeatureCollection collection,
    ...
    protected static void deleteFeatures(@NotNull PsqlEventHandler processor,
    ...
    private static void executeBatchesAndCheckOnFailures(@NotNull PsqlEventHandler processor, List<String> idList, List<String> idList2,
