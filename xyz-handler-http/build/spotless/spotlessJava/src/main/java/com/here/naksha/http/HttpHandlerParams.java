...
class HttpHandlerParams extends EventHandlerParams {
   ...
   */
  HttpHandlerParams(@NotNull Map<@NotNull String, @Nullable Object> connectorParams)
      throws MalformedURLException {
    url = new URL(parseValue(connectorParams, URL, String.class));
    connTimeout =
        parseValueWithDefault(connectorParams, CONN_TIMEOUT, TimeUnit.SECONDS.toMillis(5));
    readTimeout =
        parseValueWithDefault(connectorParams, READ_TIMEOUT, TimeUnit.SECONDS.toMillis(60));
