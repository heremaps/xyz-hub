...
public enum ApiResponseType implements CharSequence {
  EMPTY(MIMEType.APPLICATION_X_EMPTY),
  ERROR(MIMEType.APPLICATION_JSON),
  FEATURE(MIMEType.APPLICATION_GEO_JSON, GetFeaturesByTileResponseType.GEO_JSON),
  FEATURE_COLLECTION(MIMEType.APPLICATION_GEO_JSON, GetFeaturesByTileResponseType.GEO_JSON),
  COMPACT_CHANGESET(MIMEType.APPLICATION_JSON),
  CHANGESET_COLLECTION(MIMEType.APPLICATION_JSON),
  MVT(MIMEType.APPLICATION_VND_MAPBOX_VECTOR_TILE, GetFeaturesByTileResponseType.MVT, true),
  MVT_FLATTENED(MIMEType.APPLICATION_VND_MAPBOX_VECTOR_TILE, GetFeaturesByTileResponseType.MVT_FLATTENED, true),
  SPACE(MIMEType.APPLICATION_JSON),
  SPACE_LIST(MIMEType.APPLICATION_JSON),
  @Deprecated
  COUNT_RESPONSE(MIMEType.APPLICATION_JSON),
  HEALTHY_RESPONSE(MIMEType.APPLICATION_JSON),
  STATISTICS_RESPONSE(MIMEType.APPLICATION_JSON),
  HISTORY_STATISTICS_RESPONSE(MIMEType.APPLICATION_JSON);
  ...
  ApiResponseType(
      ...
      @NotNull GetFeaturesByTileResponseType tileResponseType,
      boolean binary) {
    this.binary = binary;
    this.tileResponseType = tileResponseType;
    this.contentType = contentType.toString();
