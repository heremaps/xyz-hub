...
package com.here.xyz.httpconnector.job.steps;

import static com.here.xyz.httpconnector.job.steps.Load.addLoad;
...
import com.here.xyz.httpconnector.job.steps.outputs.DownloadUrl;
import com.here.xyz.httpconnector.job.steps.outputs.Output;
...
public abstract class Step<T extends Step> implements Typed, StepExecution {
  ...
  protected final String inputS3Prefix() {
    return Job.inputS3Prefix(jobId);
  }
