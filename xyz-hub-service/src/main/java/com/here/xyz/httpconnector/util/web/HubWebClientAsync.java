...
public class HubWebClientAsync {
  ...
  public static final WorkerExecutor clientWorkers = Service.vertx.createSharedWorkerExecutor(HubWebClientAsync.class.getName(), 20);

  public static Future<Space> loadSpace(String spaceId) {
    return async(() -> HubWebClient.loadSpace(spaceId));
  }
  ...
  public static Future<StatisticsResponse> loadSpaceStatistics(String spaceId, SpaceContext context) {
    return async(() -> HubWebClient.loadSpaceStatistics(spaceId, context));
  }
  ...
  /**
   * @deprecated Please use {@link #patchSpace(String, Map)} instead.
   * @param config
   * @param spaceId
   * @return
   */
  ...
  /**
   * @deprecated Please use {@link #loadSpace(String)} instead.
   * @param spaceId
   * @return
   */
  @Deprecated
  ...
  /**
   * @deprecated Please use {@link #loadConnector(String)} instead.
   * @param connectorId
   * @return
   */
  @Deprecated
  ...
  /**
   * @deprecated Please use {@link #loadSpaceStatistics(String, SpaceContext)} instead.
   * @param spaceId
   * @param context
   * @return
   */
  ...
  /**
   * @deprecated Please use {@link #loadSpaceStatistics(String)} instead.
   * @param spaceId
   * @return
   */
  @Deprecated
  ...
  private static <R> Future<R> async(ThrowingSupplier<R> task) {
    return clientWorkers.executeBlocking(
        promise -> {
          try {
