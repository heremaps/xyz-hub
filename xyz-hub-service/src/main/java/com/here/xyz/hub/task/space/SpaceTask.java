...
public abstract class SpaceTask<EVENT extends SpaceEvent, TASK extends XyzHubTask<EVENT, TASK>> extends XyzHubTask<EVENT, TASK> {
  ...
  protected SpaceTask(@NotNull EVENT event, @NotNull RoutingContext context, ApiResponseType responseType) {
  ...
  public abstract static class ReadQuery extends SpaceTask {
  ...
  public static class MatrixReadQuery extends ReadQuery {
    ...
    public MatrixReadQuery(RoutingContext context, ApiResponseType returnType, boolean includeRights, boolean includeConnectors, String owner, PropertiesQuery propsQuery) {
      ...
      if (!Strings.isNullOrEmpty(owner)) {
        ...
        String ownOwnerId = Context.jwt(context).aid;
        switch (owner) {
          case ME:
  ...
  public static class ConditionalOperation extends SpaceTask {
    ...
    private void verifyResourceExists(ConditionalOperation task, ICallback<ConditionalOperation> callback) {
