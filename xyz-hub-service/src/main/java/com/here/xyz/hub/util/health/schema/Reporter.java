...
public class Reporter {
    ...
    @JsonView(Public.class)
    @JsonPropertyDescription("Timestamp of when the application or service was started in milliseconds elapsed since 01/01/1970")
    ...
    @JsonView(Public.class)
    @JsonPropertyDescription("Timestamp of when the application or service was build in milliseconds elapsed since 01/01/1970")
    ...
    public String toString() {
        return new ToStringBuilder(this).append("name", name).append("version", version).append("upSince", upSince).append("buildDate", buildDate).append("endpoint", endpoint).append("additionalProperties", additionalProperties).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(endpoint).append(upSince).append(name).append(buildDate).append(additionalProperties).append(version).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(endpoint, rhs.endpoint).append(upSince, rhs.upSince).append(name, rhs.name).append(buildDate, rhs.buildDate).append(additionalProperties, rhs.additionalProperties).append(version, rhs.version).isEquals();
    }
