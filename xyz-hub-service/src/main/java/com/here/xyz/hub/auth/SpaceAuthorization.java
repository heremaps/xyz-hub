...
import com.here.naksha.lib.core.util.modify.FeatureModificationList;
...
import com.here.naksha.lib.core.models.hub.Space.Static;
...
public class SpaceAuthorization extends Authorization {
  ...
  public static List<String> basicEdit = Arrays
      .asList("id", "title", "description", "client", "copyright", "license", "shared", "enableUUID", "enableHistory", "maxVersionCount",
          "cacheTTL", "readOnly", "extends", "revisionsToKeep", STORAGE, LISTENERS, PROCESSORS, SEARCHABLE_PROPERTIES, SORTABLE_PROPERTIES );
