...
public class Response implements ResponseSerializer
{
     ...
     */
    @JsonProperty("node")
    @JsonPropertyDescription("PRIVATE: The hostname or instancename that was called and where the application or service is running")
    private String node;
    /**
    ...
    public String toString() {
        return new ToStringBuilder(this).append("schemaVersion", schemaVersion).append("reporter", reporter).append("node", node).append("endpoint", endpoint).append("status", status).append("message", message).append("checks", checks).append("additionalProperties", additionalProperties).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(node).append(endpoint).append(schemaVersion).append(checks).append(reporter).append(additionalProperties).append(message).append(status).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(node, rhs.node).append(endpoint, rhs.endpoint).append(schemaVersion, rhs.schemaVersion).append(checks, rhs.checks).append(reporter, rhs.reporter).append(additionalProperties, rhs.additionalProperties).append(message, rhs.message).append(status, rhs.status).isEquals();
    }
