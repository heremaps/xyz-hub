...
public class Status implements HTTPResultMapper
{
    ...
    @JsonView(Public.class)
    @JsonPropertyDescription("Timestamp when the healthcheckresult was created in milliseconds elapsed since 01/01/1970")
    ...
    public String toString() {
        return new ToStringBuilder(this).append("result", result).append("checkDuration", checkDuration).append("timestamp", timestamp).append("additionalProperties", additionalProperties).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(result).append(additionalProperties).append(checkDuration).append(timestamp).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(result, rhs.result).append(additionalProperties, rhs.additionalProperties).append(checkDuration, rhs.checkDuration).append(timestamp, rhs.timestamp).isEquals();
    }
    ...
    public enum Result {
        ...
        private final static Map<String, Status.Result> CONSTANTS = new HashMap<String, Status.Result>();
