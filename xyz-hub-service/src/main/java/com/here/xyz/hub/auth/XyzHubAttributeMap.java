...
public class XyzHubAttributeMap extends AttributeMap {
  ...
  public static @NotNull AttributeMap ofFeature(@NotNull Feature feature) {
    ...
    attributeMap.withValue(XyzHubAttributeMap.OWNER, feature.getProperties().getXyzNamespace().getOwner());
    return attributeMap;
  }
  ...
  public static @NotNull AttributeMap ofSpace(@NotNull Space space) {
    ...
    attributeMap.withValue(XyzHubAttributeMap.OWNER, space.getProperties().getXyzNamespace().getOwner());
  ...
  public static @NotNull AttributeMap ofConnector(@NotNull Connector connector) {
    ...
    attributeMap.withValue(XyzHubAttributeMap.OWNER, connector.getProperties().getXyzNamespace().getOwner());
