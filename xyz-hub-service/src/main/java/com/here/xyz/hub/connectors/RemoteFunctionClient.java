...
public abstract class RemoteFunctionClient {
    ...
    public static RemoteFunctionClient getInstanceFor(Connector connectorConfig) {
        if (connectorConfig == null) throw new NullPointerException("Can not create RemoteFunctionClient without connector configuration.");
     ...
     * whenever the connector configuration was changed during the runtime.
     */
    ...
    /**
     * Measures the occurance of events in relation to the time having passed by since the last measurement.
     * This is at minimum the value of {@link #MEASUREMENT_INTERVAL}.
     *
     * @param eventCount A counter for the events having occurred so far within the current time-interval
     * @param lastMeasurementTime The point in time when the last measurement was done
     *  This reference will be updated in case the time-interval was exceeded
     * @return The new current value for the dimension.
     *  If the time-interval was exceeded this is a newly calculated value
    ...
    public Connector getConnectorConfig() { return connectorConfig; }
