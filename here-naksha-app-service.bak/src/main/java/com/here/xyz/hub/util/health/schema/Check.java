...
@JsonPropertyOrder({"name", "essential", "role", "target", "status", "response"})
public class Check {
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder()
        ...
        .append(essential, rhs.essential)
  ...
  public enum Role {
    ...
    private static final Map<String, Check.Role> CONSTANTS = new HashMap<>();
  ...
  public enum Target {
    ...
    REMOTE("REMOTE");
    private final String value;
    private static final Map<String, Check.Target> CONSTANTS = new HashMap<>();
