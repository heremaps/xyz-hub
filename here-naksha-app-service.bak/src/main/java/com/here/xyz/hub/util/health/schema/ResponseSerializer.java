...
public interface ResponseSerializer {
  ...
  static ObjectWriter publicWriter =
      internalMapper.copy().disable(MapperFeature.DEFAULT_VIEW_INCLUSION).writerWithView(Public.class);
  ...
  public default String toResponseString(String secretHeaderValue) {
    return isPublicRequest(secretHeaderValue) ? toInternalResponseString() : toPublicResponseString();
  }

  public default String toResponseString(Map<String, String> requestHeaders) {
    return toResponseString(requestHeaders != null ? requestHeaders.get(Config.getHealthCheckHeaderName()) : null);
  }
}
