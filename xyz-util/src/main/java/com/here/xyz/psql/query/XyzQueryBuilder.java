...
public abstract class XyzQueryBuilder<I> extends QueryBuilder<I> {
  ...
  public XyzQueryBuilder withConnectorParameters(ConnectorParameters connectorParameters) {
    setConnectorParameters(connectorParameters);
    return this;
  }
}
