...
public class SQLNonCompositeWithHistoryTestSuiteIT extends SQLBasedTestSuite {
  ...
  public static List<TestArgs> testScenarios() throws JsonProcessingException {
    return List.of(
        /** Feature NOT exists */
        new TestArgs("0", true, false, UserIntent.WRITE, OnNotExists.CREATE, null, null, null, null,
            /* Expected content of the written Feature */
            new TestAssertions(INSERT, I)
        ),
        /* No existing Feature expected. No TableOperation! */
        new TestArgs("1", true, false, UserIntent.WRITE, OnNotExists.ERROR, null, null, null, null,
            new TestAssertions(FEATURE_NOT_EXISTS)),
        /* No existing Feature expected. No TableOperation! */
        new TestArgs("2", true, false, UserIntent.WRITE, OnNotExists.RETAIN, null, null, null, null,
            new TestAssertions()),

        /** Feature exists + no ConflictHandling */
        new TestArgs("3", true, true, UserIntent.WRITE, null, OnExists.DELETE, null, null, null,
            /* Expected content of the deleted Feature (History). */
            new TestAssertions(INSERT, D)
        ),
        new TestArgs("4", true, true, UserIntent.WRITE, null, OnExists.REPLACE, null, null, null,
            /* Expected content of the replaced Feature (2th write). */
            new TestAssertions(INSERT, U)
        ),
        new TestArgs("5", true, true, UserIntent.WRITE, null, OnExists.RETAIN, null, null, null,
            /* Expected content of the untouched Feature (from 1th write). No TableOperation! */
            new TestAssertions()
        ),
        new TestArgs("6", true, true, UserIntent.WRITE, null, OnExists.ERROR, null, null, null,
        ...
        new TestArgs("7", true, true, true, UserIntent.WRITE, null, OnExists.DELETE, OnVersionConflict.REPLACE,
            null, null,
            /* Expected content of the deleted Feature (3rd write) (History) */
            new TestAssertions(INSERT, D)
        ),
        new TestArgs("8", true, true, true, UserIntent.WRITE, null, OnExists.REPLACE, OnVersionConflict.REPLACE,
            null, null,
            /* Expected content of the replaced Feature (3th write) */
            new TestAssertions(INSERT, U)
        ),
        new TestArgs("9", true, true, true, UserIntent.WRITE, null, OnExists.RETAIN, OnVersionConflict.REPLACE,
            null, null,
            /* Expected content of the untouched Feature (from 2th write). No TableOperation! */
            new TestAssertions()
        ),
        new TestArgs("10", true, true, true, UserIntent.WRITE, null, OnExists.ERROR, OnVersionConflict.REPLACE,
            null, null,
        ...
        new TestArgs("11", true, true, false, UserIntent.WRITE, null, null, OnVersionConflict.ERROR, null, null,
        ...
        new TestArgs("12", true, true, false, UserIntent.WRITE, null, null, OnVersionConflict.RETAIN, null, null,
            /* Expected content of the untouched Feature (from 2th write). No TableOperation! */
            new TestAssertions()
        ),
        /**  Feature exists and got updated. Third write will have a Baseversion MISSMATCH. With ConflictHandling -> REPLACE */
        new TestArgs("13", true, true, false, UserIntent.WRITE, null, OnExists.DELETE, OnVersionConflict.REPLACE,
            null, null,
            /* Expected content of the deleted Feature (3rd write) (History) */
            new TestAssertions(INSERT, D)
        ),
        new TestArgs("14", true, true, false, UserIntent.WRITE, null, OnExists.REPLACE, OnVersionConflict.REPLACE,
            null, null,
            /* Expected content of the replaced Feature (3th write). */
            new TestAssertions(INSERT, U)
        ),
        new TestArgs("15", true, true, false, UserIntent.WRITE, null, OnExists.RETAIN, OnVersionConflict.REPLACE,
            null, null,
            /* Expected content of the untouched Feature (from 2th write). No TableOperation! */
            new TestAssertions()
        ),
        new TestArgs("16", true, true, false, UserIntent.WRITE, null, OnExists.ERROR, OnVersionConflict.REPLACE,
            null, null,
            /* Expected content of the untouched Feature (from 2th write). No TableOperation! */
            new TestAssertions(FEATURE_EXISTS)
        ),
        ...
        new TestArgs("17", true, true, false, false, UserIntent.WRITE, null, null, OnVersionConflict.MERGE, null, null,
        ...
        new TestArgs("18", true, true, false, true, UserIntent.WRITE, null, null, OnVersionConflict.MERGE,
