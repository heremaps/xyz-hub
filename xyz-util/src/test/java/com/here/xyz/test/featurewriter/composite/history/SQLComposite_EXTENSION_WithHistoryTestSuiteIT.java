...
public class SQLComposite_EXTENSION_WithHistoryTestSuiteIT extends SQLNonCompositWithHistoryTestSuiteIT {

    public SQLComposite_EXTENSION_WithHistoryTestSuiteIT(String testName, boolean composite, boolean history, boolean featureExists,
