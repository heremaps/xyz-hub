...
/**
 * A PostgresQL collection is a physical storage as understood by Naksha PostgresQL library. The same collection can have multiple space
...
public class PsqlCollection {
   ...
   */
  @JsonProperty(SCHEMA)
  @JsonView({View.Export.Public.class, View.Import.Public.class}) // We do not import/export to storage, so to comment of table!
