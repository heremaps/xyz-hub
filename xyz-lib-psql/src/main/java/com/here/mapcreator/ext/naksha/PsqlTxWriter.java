...
public class PsqlTxWriter extends PsqlTxReader implements ITxWriter {
  ...
  @Override
  public @NotNull StorageCollection dropCollection(@NotNull StorageCollection collection, long deleteAt) throws SQLException {
  ...
  @Override
  public @NotNull <F extends Feature> PsqlFeatureWriter<F> writeFeatures(@NotNull Class<F> featureClass,
