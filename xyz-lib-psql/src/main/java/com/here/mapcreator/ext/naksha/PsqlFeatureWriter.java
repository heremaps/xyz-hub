...
public class PsqlFeatureWriter<FEATURE extends Feature> extends PsqlFeatureReader<FEATURE> implements IFeatureWriter<FEATURE> {

  PsqlFeatureWriter(@NotNull PsqlTxWriter storageWriter, @NotNull Class<FEATURE> featureClass, @NotNull StorageCollection collection) {
  ...
  @Override
  public @NotNull ModifyFeaturesResp<FEATURE> modifyFeatures(@NotNull ModifyFeaturesReq<FEATURE> req) throws SQLException {
