...
public class MaintenanceSQL {
  ...
  public static String generateCheckExtensionsSQL(
      boolean hasPropertySearch, String user, String db) {
  ...
  public static String createIDXInitEntry =
      "INSERT INTO xyz_config."
          + XYZ_CONFIG_IDX_TABLE
          + " (spaceid,count) "
          + "   VALUES ('idx_in_progress','0') "
  ...
  public static String createTxnPubTableSQL =
      "CREATE TABLE IF NOT EXISTS "
          + XYZ_CONFIG_SCHEMA
          + "."
          + XYZ_CONFIG_TXN_PUB_TABLE
