...
import com.here.xyz.storage.ITxWriter;
...
public class PsqlTxWriter extends PsqlTxReader implements ITxWriter {
  ...
  @Override
  public @NotNull StorageCollection createCollection(@NotNull StorageCollection collection)
      throws SQLException {
    throw new UnsupportedOperationException("createCollection");
  }

  @Override
  public @NotNull StorageCollection updateCollection(@NotNull StorageCollection collection)
      throws SQLException {
    throw new UnsupportedOperationException("updateCollection");
  }

  @AvailableSince(INaksha.v2_0)
  public @NotNull StorageCollection upsertCollection(@NotNull StorageCollection collection)
      throws SQLException {
    throw new UnsupportedOperationException("updateCollection");
  }

  @Override
  public @NotNull StorageCollection dropCollection(
      @NotNull StorageCollection collection, long deleteAt) throws SQLException {
    throw new UnsupportedOperationException("dropCollection");
  }

  @Override
  public @NotNull StorageCollection enableHistory(@NotNull StorageCollection collection)
      throws SQLException {
    throw new UnsupportedOperationException("enableHistory");
  }

  @Override
  public @NotNull StorageCollection disableHistory(@NotNull StorageCollection collection)
      throws SQLException {
