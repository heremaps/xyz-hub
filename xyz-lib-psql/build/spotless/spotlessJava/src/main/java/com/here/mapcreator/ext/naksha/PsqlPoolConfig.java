...
public class PsqlPoolConfig {
  ...
  @JsonIgnore public final String driverClass = "org.postgresql.Driver";

  /** The database host to connect against. */
  @JsonProperty public final @NotNull String host;
  ...
  @JsonProperty public final @NotNull String db;

  /** The user. */
  @JsonProperty public final @NotNull String user;

  /** The password. */
  @JsonProperty public final @NotNull String password;
  ...
  @JsonProperty public final long connTimeout;
   ...
   */
  @JsonProperty public final long stmtTimeout;
  ...
  @JsonProperty public final int minPoolSize;

  /** The maximal connections to use. */
  @JsonProperty public final int maxPoolSize;
   ...
   */
  @JsonProperty public final long idleTimeout;

  @JsonIgnore public final @NotNull String url;
  ...
  PsqlPoolConfig(
    ...
    this.connTimeout =
        connTimeout != null && connTimeout > 0L ? max(connTimeout, 1000L) : SECONDS.toMillis(15);
    this.stmtTimeout =
        stmtTimeout != null && stmtTimeout > 0L ? max(stmtTimeout, 1000L) : SECONDS.toMillis(60);
    this.lockTimeout =
        lockTimeout != null && lockTimeout > 0L ? max(lockTimeout, 1000L) : SECONDS.toMillis(15);
    this.minPoolSize = minPoolSize != null && minPoolSize > 0 ? minPoolSize : 1;
    this.maxPoolSize =
        maxPoolSize != null && maxPoolSize >= this.minPoolSize
            ? maxPoolSize
            : max(this.minPoolSize, 200);
    this.idleTimeout =
        idleTimeout != null && idleTimeout > 0L ? max(idleTimeout, 60L) : MINUTES.toSeconds(10);
