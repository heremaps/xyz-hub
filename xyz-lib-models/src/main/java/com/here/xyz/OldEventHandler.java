...
public abstract class OldEventHandler implements IEventHandler {
  ...
  public static synchronized <H extends OldEventHandler> void register(@NotNull String id, @NotNull Class<H> handlerClass) {
   ...
   */
  @SuppressWarnings("unchecked")
  public static <H extends OldEventHandler> @NotNull H newInstance(@NotNull Connector connector) throws XyzErrorException {
