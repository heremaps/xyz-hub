...
/**
 * The object to return, when a {@link FibMap#put(Object, Object, Object, boolean, Object[])} fails, because the current value is not the
 * expected. The constructor ({@code FibMapConflict::new}) can be passed as last argument to
 * {@link FibMap#put(Object, Object, Object, boolean, Object[], F1, F4)}.
 *
