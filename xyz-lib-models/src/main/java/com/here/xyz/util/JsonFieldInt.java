...
public final class JsonFieldInt<OBJECT> extends JsonField<OBJECT, Integer> {
  ...
  JsonFieldInt(@NotNull JsonClass<OBJECT> jsonClass, @NotNull Field javaField, int index, @NotNull String jsonName,
      @Nullable String defaultValue) {
    super(jsonClass, javaField, index, jsonName, defaultValue);
    this.nullValue = 0;
    this.defaultValue = defaultValue != null && defaultValue.length() > 0 ? Integer.parseInt(defaultValue) : nullValue;
  }
