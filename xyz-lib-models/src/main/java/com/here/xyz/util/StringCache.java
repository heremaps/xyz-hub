...
public final class StringCache extends WeakReference<String> implements CharSequence, ILike {
   ...
   * The advantage of the method is that it guarantees that the same character sequence always returns the same {@link String} instance,
   * therefore comparing the strings can be done by reference. Apart it guarantees that only one version of the string is kept in memory.
   *
