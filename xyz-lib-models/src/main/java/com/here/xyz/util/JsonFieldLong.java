...
public final class JsonFieldLong<OBJECT> extends JsonField<OBJECT, Long> {
  ...
  JsonFieldLong(@NotNull JsonClass<OBJECT> jsonClass, @NotNull Field javaField, int index, @NotNull String jsonName,
      @Nullable String defaultValue) {
    super(jsonClass, javaField, index, jsonName, defaultValue);
    this.nullValue = 0L;
    this.defaultValue = defaultValue != null && defaultValue.length() > 0 ? Long.parseLong(defaultValue) : nullValue;
  }
