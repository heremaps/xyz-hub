...
/**
 * An in-memory cache for a storage collection. It can be configured to only keep parts of the underlying storage collection in memory using
 * weak references or to keep all features of the storage in memory.
 */
