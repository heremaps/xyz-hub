...
public interface IEventContext {
  ...
  /**
   * Change the event and send it upstream to the next event handler. If no further handler is available, the default implementation at the
   * end of each pipeline will return a not implemented error response.
   * <p>
   * Note: Calling this method is the same as: <pre>{@code
