...
/**
 * All configurations that represent an event-pipeline component must extend this class. A pipelined component is a component, that acts on
 * events send through an event-pipeline.
 */
