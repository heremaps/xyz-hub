...
public final class PluginCache {
   ...
   * @throws ClassNotFoundException if no such class exists, or the class does not implement the requested API.
  ...
  public static <API, PARAM> @NotNull Constructor<API> get(
      ...
      @NotNull Class<PARAM> paramClass
