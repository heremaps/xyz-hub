...
/**
 * A transaction event list, persists out of multiple transaction events. Each event represents something that has happened as part of the
 * transaction. This is the container that is used to transport all transactions.
 */
...
public class TxSignalSet implements Iterable<TxSignal> {
  ...
  /**
   * Return the transaction number, which all events being part of the transaction list share, or {@code null}, if the set does not have any
   * event elements.
   *
