 ...
 * <p>
 * If selected, returning the data in a clustered way. This means the data is not necessarily returned in its original shape or with its
 * original properties. Depending on the chosen clustering algorithm, there could be different mandatory and/or optional parameters to
