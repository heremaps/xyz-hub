...
/**
 * The "quadbin" algorithm takes the geometry input from the request (for example, quadkey / bbox..) and count the features in it.
 * <p>
 * This clustering mode works also for large spaces and can be used for getting an overview where data is present in a given space.
 * Furthermore, a property filter on one property is applicable.
 */
...
public class ClusteringQuadBin extends Clustering {
  ...
  public enum CountMode {
    ...
    ESTIMATED("estimated"),
    /**
     * Estimated feature counts combined with real ones, if the estimation is low a real count gets applied. Fits to the most use cases.
     * This is the default.
     */
    MIXED("mixed");
