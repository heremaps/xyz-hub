...
public class MapKeySet<K, V> implements Set<@NotNull K> {
  ...
  @JsonIgnore protected final @NotNull Map<K, V> map;

  @JsonIgnore protected final @NotNull Set<Map.Entry<@NotNull K, @Nullable V>> mapSet;

  @JsonIgnore protected @Nullable MapEntry<K, V> entry;
