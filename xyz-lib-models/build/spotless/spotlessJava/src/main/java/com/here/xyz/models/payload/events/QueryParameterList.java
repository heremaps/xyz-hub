...
public class QueryParameterList implements Iterable<QueryParameter> {
   ...
   */
  public QueryParameterList(
      @Nullable CharSequence query_string, @Nullable QueryParameterDecoder decoder)
   ...
   * @throws ParameterError If parsing the query string failed.
   */
  public QueryParameterList(@Nullable CharSequence query_string, int start, int end)
      throws ParameterError {
   ...
   */
  public QueryParameterList(
      @Nullable CharSequence query_string,
      int start,
      int end,
      @Nullable QueryParameterDecoder decoder)
      throws ParameterError {
    map = new LinkedHashMap<>(16);
    list = new ArrayList<>(16);
    UNDEFINED = new QueryParameter(this, "", -1);
  ...
  protected void addValue(
      @NotNull QueryParameter param, @Nullable Object value, @Nullable QueryDelimiter delimiter) {
