...
public abstract class JsonField<OBJECT, VALUE> implements CharSequence {
  ...
  public static final ConcurrentHashMap<
          Class, F5<JsonField, JsonClass, Field, Integer, String, String>>
  ...
  public static <OBJECT, VALUE> void register(
      ...
      @NotNull F5<? extends JsonField<OBJECT, VALUE>, JsonClass<OBJECT>, Field, Integer, String, String>
              constructor) {
    constructors.put(
        valueType, (F5<JsonField, JsonClass, Field, Integer, String, String>) (F5) constructor);
  }
   ...
   */
  static @NotNull JsonField<?, ?> construct(
      @NotNull JsonClass<?> jsonClass, @NotNull Field javaField, int index) {
  ...
  public boolean compareAndSwap(
      @NotNull Object object, @Nullable Object expected, @Nullable Object value) {
    final OBJECT target = object(object);
