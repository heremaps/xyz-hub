...
public final class FibMap {
   ...
   * href="https://www.rapidtables.com/convert/number/decimal-to-binary.html">www.rapidtables.com</a>.
   */
  public static final long MUL64 =
      0b1001111000110111011110011011100101111111010010100111110000010101L;
  ...
  public static @Nullable Object put(
    ...
    if (new_value instanceof FibMapConflict
        || new_value == CONFLICT
        || new_value == ANY
        || new_value == VOID) {
      throw new IllegalArgumentException(
          "new value must not be FibConflict, CONFLICT, ANY or VOID");
    }
  ...
  static @Nullable Object _put(
    ...
    while (true) {
      ...
      if (existing_key instanceof Object[] segment) {
        ...
        return _put(
            key, key_hash, expected_value, new_value, create, segment, depth + 1, intern, conflict);
      }
