...
public class JsonMap
  ...
  @JsonIgnore protected @Nullable Object @NotNull [] root;

  @JsonIgnore protected int size;
  ...
  /**
   * Create a conflict result, this just returns {@link FibMap#CONFLICT}. If more details needed,
   * use {@link FibMapConflict#FibMapConflict(Object, Object, Object, Object)}.
   *
  ...
  public @Nullable Object put(@NotNull CharSequence key, @Nullable Object value) {
    ...
    final Object old =
        FibMap.put(key, ANY, value, true, rootMutable(), this::intern, this::conflict);
    if (old == UNDEFINED) {
  ...
  public @Nullable Object putIfAbsent(@NotNull CharSequence key, @Nullable Object value) {
    ...
    final Object old =
        FibMap.put(key, UNDEFINED, value, true, rootMutable(), this::intern, this::conflict);
    if (old == UNDEFINED) {
      SIZE.getAndAdd(this, -1);
      return null;
    }
  ...
  @Override
  public @Nullable Object computeIfAbsent(
      @NotNull String key, @NotNull Function<? super String, ?> fn) {
    Object oldValue = FibMap.get(key, root);
    if (oldValue == UNDEFINED) {
      final Object newValue = fn.apply(key);
      if (newValue != null && newValue != UNDEFINED) {
        oldValue =
            FibMap.put(key, UNDEFINED, newValue, true, rootMutable(), this::intern, this::conflict);
  ...
  public @Nullable Object compute(
      @NotNull String key, BiFunction<? super String, ? super Object, ?> fn) {
    // TODO: Fix for fields
    while (true) {
  ...
  public final boolean replace(
      @NotNull String key, @Nullable Object oldValue, @Nullable Object newValue) {
  ...
  public boolean replace(
      @NotNull CharSequence key, @Nullable Object expectedValue, @Nullable Object newValue) {
    // TODO: Fix for fields
    if (newValue == ANY) {
      throw new IllegalArgumentException("newValue must not be ANY");
    }
    final Object oldValue =
        FibMap.put(key, expectedValue, newValue, true, rootMutable(), this::intern, this::conflict);
  ...
  public @Nullable Object replace(@NotNull CharSequence key, @Nullable Object newValue) {
    // TODO: Fix for fields
    final Object oldValue =
        FibMap.put(key, ANY, newValue, false, rootMutable(), this::intern, this::conflict);
    assert oldValue != UNDEFINED;
    // Note: A conflict should only happen, when the value is undefined, therefore the value in a
    // conflict case must be UNDEFINED!
  ...
  @JsonIgnore private @Nullable JsonMapEntrySet entrySet;
    ...
    try {
      ROOT =
          MethodHandles.lookup()
              .in(JsonMap.class)
              .findVarHandle(JsonMap.class, "root", Object[].class);
      SIZE =
          MethodHandles.lookup().in(JsonMap.class).findVarHandle(JsonMap.class, "size", int.class);
