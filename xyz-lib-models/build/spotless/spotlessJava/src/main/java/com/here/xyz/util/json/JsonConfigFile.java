...
public abstract class JsonConfigFile<SELF extends JsonConfigFile<SELF>>
   ...
   */
  public final @NotNull SELF load(
      final @Nullable Function<@NotNull String, @Nullable String> getEnv) throws IOException {
  ...
  @JsonIgnore private String loadPath;
