...
public class JsonObjectEntryIterator
    implements Iterator<@NotNull Entry<@NotNull String, @Nullable Object>> {
  ...
  private @Nullable Iterator<@NotNull Entry<@NotNull String, @Nullable Object>>
      additionalPropertiesIt;
