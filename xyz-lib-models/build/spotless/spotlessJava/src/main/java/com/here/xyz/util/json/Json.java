...
public final class Json implements AutoCloseable {
  ...
  private final HashMap<@NotNull Class<? extends Deserialize>, @NotNull ObjectReader> readers =
      new HashMap<>();
  private final HashMap<@NotNull Class<? extends Serialize>, @NotNull ObjectWriter> writers =
      new HashMap<>();
  private final HashMap<@NotNull Class<? extends Serialize>, @NotNull ObjectWriter> pretty_writers =
      new HashMap<>();
