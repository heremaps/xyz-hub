...
public final class Sampling {
   ...
   */
  private Sampling(
      int numerator, int denominator, int strength, int threshold, @NotNull String name) {
    this.numerator = numerator;
    this.denominator = denominator;
    this.strength = strength;
    this.threshold = threshold;
  ...
  private static final ConcurrentHashMap<@NotNull String, @NotNull Sampling> allByText =
