...
public class JsonObject
  ...
  @JsonIgnore final @NotNull JsonMap additionalProperties;

  /** A map that stores, which fields where virtually removed. */
  @JsonIgnore private long @Nullable [] removed;
  ...
  @JsonIgnore private @Nullable JsonClass<?> jsonClass;
  ...
  public boolean replace(
    ...
    final JsonField<?, ?> field = jsonClass.getField(key);
    if (field != null) {
      return setFieldValue(field, expectedValue == null ? VOID : expectedValue, newValue, true)
          != CONFLICT;
    }
  ...
  @JsonIgnore private @Nullable JsonObjectEntrySet entrySet;
