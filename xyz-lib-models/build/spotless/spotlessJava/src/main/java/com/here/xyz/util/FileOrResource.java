...
public abstract class FileOrResource<SELF extends FileOrResource<SELF>> {
  ...
  @JsonIgnore protected @NotNull String filename;
  @JsonIgnore protected @Nullable String searchPath;
  ...
  public @NotNull InputStream open(@Nullable String searchPath)
      throws NullPointerException, IOException {
    String filePath = null;
    try {
      final Path path =
          (searchPath != null ? Paths.get(searchPath, filename) : Paths.get(filename))
              .toAbsolutePath();
