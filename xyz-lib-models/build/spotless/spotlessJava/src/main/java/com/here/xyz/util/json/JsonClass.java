...
public final class JsonClass<CLASS> {
  ...
  private static final ConcurrentHashMap<@NotNull Class<?>, @NotNull JsonClass<?>> cache =
      ...
      if (new_fields_count > 0) {
        ...
        for (final @Nullable Field field : fields) {
          if (field != null) {
            //noinspection unchecked
            jsonFields[newIndex++] =
                (JsonField<CLASS, ?>) JsonField.construct(this, field, newIndex);
          }
        }
      }
   ...
   */
  public <VALUE> @NotNull JsonField<CLASS, VALUE> getField(
      int index, @NotNull Class<VALUE> valueClass) {
