...
class PatcherTest {
  ...
  void basic() throws IOException {
    final Feature f1 =
        JsonSerializable.deserialize(IoHelp.readResource("patcher/feature_1.json"), Feature.class);
    assertNotNull(f1);

    final Feature f2 =
        JsonSerializable.deserialize(IoHelp.readResource("patcher/feature_2.json"), Feature.class);
    assertNotNull(f2);
  ...
  private static boolean ignoreAll(
      @NotNull Object key, @Nullable Map source, @Nullable Map target) {
    return true;
  }
  ...
  private static boolean ignoreXyzProps(
      @NotNull Object key, @Nullable Map source, @Nullable Map target) {
