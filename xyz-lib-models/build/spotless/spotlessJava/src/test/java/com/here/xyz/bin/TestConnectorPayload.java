...
public class TestConnectorPayload {
  ...
  private static final byte[] SAMPLE_BYTES = {
    16, 0, 0, 0, 0, 0, 10, 0, 16, 0, 4, 0, 8, 0, 12, 0, 10, 0, 0, 0, 52, 0, 0, 0, 32, 0, 0, 0, 4, 0,
    0, 0, 18, 0, 0, 0, 115, 111, 109, 101, 32, 115, 97, 109, 112, 108, 101, 32, 115, 116, 114, 105,
    110, 103, 0, 0, 8, 0, 0, 0, 116, 101, 115, 116, 69, 116, 97, 103, 0, 0, 0, 0, 16, 0, 0, 0, 97,
    112, 112, 108, 105, 99, 97, 116, 105, 111, 110, 47, 106, 115, 111, 110, 0, 0, 0, 0
  };

  @Test
  public void testReadBytes() {
    ConnectorPayload payload =
        ConnectorPayload.getRootAsConnectorPayload(ByteBuffer.wrap(SAMPLE_BYTES));
