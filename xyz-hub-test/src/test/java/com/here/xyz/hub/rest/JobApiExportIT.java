...
public class JobApiExportIT extends JobApiIT {
    ...
    public void testFullWKBExport() throws Exception {
        ...
        URL downloadUrl = performExport(job, testSpaceId2, Job.Status.finalized, Job.Status.failed);
        ...
        downloadAndCheck(downloadUrl, 5401, 11, mustContains );
    ...
    public void testFilteredWKBExportWithSpatialFilterClipped() throws Exception {
        ...
        downloadAndCheck(downloadUrl, 4062, 5, mustContains );
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFilteredWKBExportWithSpatialFilterUnclipped() throws Exception {
        ...
        downloadAndCheck(downloadUrl, 2622, 5, mustContains );
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFilteredWKBExportWithPropFilter() throws Exception {
        ...
        downloadAndCheck(downloadUrl, 983, 3, mustContains );
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFilteredWKBExportWithPropAndSpatialFilter() throws Exception {
        ...
        downloadAndCheck(downloadUrl, 359, 1, mustContains );
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFullGEOJSONCompositeL1Export() throws Exception {
        /** Create job */
        Export job = buildTestJob(null, new Export.ExportTarget().withType(Export.ExportTarget.Type.DOWNLOAD), Job.CSVFormat.GEOJSON);
        URL downloadUrl = performExport(job, testSpaceId2Ext, Job.Status.finalized, Job.Status.failed);
    ...
    public void testFilteredGEOJSONCompositeL2WithPropAndSpatialFilter() throws Exception {
        ...
        /** Create job */
        Export job = buildTestJob(filters, new Export.ExportTarget().withType(Export.ExportTarget.Type.DOWNLOAD), Job.CSVFormat.GEOJSON);
        URL downloadUrl = performExport(job, testSpaceId2ExtExt, Job.Status.finalized, Job.Status.failed);
    ...
    public void testFullVMLExport() throws Exception {
        ...
        URL downloadUrl = performExport(job, testSpaceId2, Job.Status.failed, Job.Status.finalized);
        ...
        downloadAndCheckFC(downloadUrl, 5441, 10, csvMustContains, 1);
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFilteredVMLExportWithSpatialFilterClipped() throws Exception {
        ...
        downloadAndCheckFC(downloadUrl, 4153, 5, mustContains, 1);
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFilteredVMLExportWithSpatialFilterUnclipped() throws Exception {
        ...
        downloadAndCheckFC(downloadUrl, 2805, 5, mustContains, 1);
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFilteredVMLExportWithPropFilter() throws Exception {
        ...
        downloadAndCheckFC(downloadUrl, 1273, 3, mustContains, 1);
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFilteredVMLExportWithPropAndSpatialFilter() throws Exception {
        ...
        downloadAndCheckFC(downloadUrl, 505, 1, mustContains, 1 );
        deleteJob(testExportJobId, testSpaceId2);
    }
    ...
    public void testFullVMLCompositeL1Export() throws Exception {
        ...
        /** Create job */
        Export job =  buildVMTestJob(null, exportTarget, Job.CSVFormat.TILEID_FC_B64, targetLevel, maxTilesPerFile);
        URL downloadUrl = performExport(job, testSpaceId2Ext, Job.Status.failed, Job.Status.finalized);
        ...
        // 252 + 10 (-feature w/o geometry) = 262
        downloadAndCheckFC(downloadUrl, 138317, 262, mustContains, 37);
        deleteJob(testExportJobId, testSpaceId2Ext);
    }
    ...
    public void testFullVMLCompositeL2Export() throws Exception {
        ...
        /** Create job */
        Export job =  buildVMTestJob(null, exportTarget, Job.CSVFormat.TILEID_FC_B64, targetLevel, maxTilesPerFile);
        URL downloadUrl = performExport(job, testSpaceId2ExtExt, Job.Status.failed, Job.Status.finalized);
        ...
        downloadAndCheckFC(downloadUrl, 138673, 263, mustContains, 37);
        deleteJob(testExportJobId, testSpaceId2ExtExt);
    }
    ...
    public void testFilteredVMLCompositeL1ExportWithSpatialFilter() throws Exception {
        ...
        downloadAndCheckFC(downloadUrl, 15541, 30, mustContains, 1 );
        deleteJob(testExportJobId, testSpaceId2Ext);
    }
    ...
    public void testFilteredVMLCompositeL1ExportWithPropAndSpatialFilter() throws Exception {
        ...
        downloadAndCheckFC(downloadUrl, 477, 1, mustContains, 1);
        deleteJob(testExportJobId, testSpaceId2Ext);
    }
    ...
    public void testFilteredVMLCompositeL2WithPropAndSpatialFilter() throws Exception {
        ...
        downloadAndCheckFC(downloadUrl, 15901, 31, mustContains, 1);
        deleteJob(testExportJobId, testSpaceId2ExtExt);
    }

    /** ------------------- HELPER -------------------- */
    public URL performExport(Export job, String spaceId, Job.Status expectedStatus, Job.Status failStatus) throws Exception {
        /** Create job */
        postJob(job, spaceId)
        ...
        if(job.getExportTarget().getType().equals(Export.ExportTarget.Type.DOWNLOAD))
            return job.getExportObjects().get("export.csv").getDownloadUrl();
        return job.getExportObjects().get("0-1.csv").getDownloadUrl();
    }
    ...
    public static String downloadAndCheck(URL url, int expectedByteSize, int expectedFeatureCount, List<String> csvMustContains) throws IOException {
        ...
        assertEquals(expectedByteSize, bos.size());

        String result = new String(bos.toByteArray(), StandardCharsets.UTF_8);
        assertEquals(expectedFeatureCount, result.split("'\"id'\"", -1).length-1);
    ...
    public static void downloadAndCheckFC(URL url, int expectedByteSize, int expectedFeatureCount, List<String> csvMustContains, Integer expectedTileCount) throws IOException {
        List<String> tileIds = new ArrayList<>();
        int lineCount = 0;
        int featureCount = 0;

        String result = downloadAndCheck(url,expectedByteSize, 0, csvMustContains);
