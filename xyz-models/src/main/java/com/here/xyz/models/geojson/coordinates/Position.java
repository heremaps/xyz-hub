...
public class Position extends ArrayList<Double> implements IBoundedCoordinates {
   ...
   * @return the coordinate implementation or null, if the list is null, empty or does not contain two or three numbers.
   */
  public static Position fromList(final List<?> coordinates) {
    ...
    if ((raw0 instanceof Number) && //
      ...
      return new Position(longitude, latitude, altitude != null
          ? altitude
          : 0d);
    }
