...
public class GeometryCollection extends Geometry {
  ...
  public BBox calculateBBox() {
    ...
    if (minLon != Double.MAX_VALUE && minLat != Double.MAX_VALUE && maxLon != Double.MIN_VALUE && maxLat != Double.MIN_VALUE) {
  ...
  protected com.vividsolutions.jts.geom.GeometryCollection convertToJTSGeometry() {
    ...
    com.vividsolutions.jts.geom.Geometry[] jtsGeometries = new com.vividsolutions.jts.geom.Geometry[this.geometries.size()];
    ...
    for (GeometryItem geometry : this.geometries) {
      try {
        ...
        throw new InvalidGeometryException(
            "The geometry with type " + geometry.getClass().getSimpleName() + " is invalid, reason: " + e.getMessage());
      }
    }
  }
}
