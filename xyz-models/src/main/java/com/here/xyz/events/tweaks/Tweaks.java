...
public abstract class Tweaks implements Typed {
   ...
   * allow to either select a pre-defined name via "&tweaks:sampling" and to override individual values via "&tweaks:sampling:strength".
   * The default selection is always “off”.
   */
  @JsonProperty
