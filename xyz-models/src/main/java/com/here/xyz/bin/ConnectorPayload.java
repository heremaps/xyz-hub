...
public final class ConnectorPayload extends Table {
  ...
  public static ConnectorPayload getRootAsConnectorPayload(ByteBuffer _bb) { return getRootAsConnectorPayload(_bb, new ConnectorPayload()); }
  public static ConnectorPayload getRootAsConnectorPayload(ByteBuffer _bb, ConnectorPayload obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public ConnectorPayload __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public String etag() { int o = __offset(6); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer etagAsByteBuffer() { return __vector_as_bytebuffer(6, 1); }
  public ByteBuffer etagInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 6, 1); }
  ...
  public static int createConnectorPayload(FlatBufferBuilder builder,
      int mime_typeOffset,
      int etagOffset,
      int bytesOffset) {
  ...
  public static void startConnectorPayload(FlatBufferBuilder builder) { builder.startTable(3); }
  public static void addMimeType(FlatBufferBuilder builder, int mimeTypeOffset) { builder.addOffset(0, mimeTypeOffset, 0); }
  public static void addEtag(FlatBufferBuilder builder, int etagOffset) { builder.addOffset(1, etagOffset, 0); }
  ...
  public static void finishConnectorPayloadBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedConnectorPayloadBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ConnectorPayload get(int j) { return get(new ConnectorPayload(), j); }
    public ConnectorPayload get(ConnectorPayload obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
