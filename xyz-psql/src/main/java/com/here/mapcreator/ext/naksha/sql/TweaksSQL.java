...
public class TweaksSQL {
  ...
  */
  ...
  public static String strengthSql(int strength, boolean bRandom) {
    if (!bRandom) {
      final double bxLen = (strength <= 5 ? 0.001 :
          strength <= 10 ? 0.002 :
              strength <= 30 ? 0.004 :
                  strength <= 50 ? 0.008 :
  ...
  public static String
      requestedTileBoundsSql = DhString.format("ST_MakeEnvelope(%%.%1$df,%%.%1$df,%%.%1$df,%%.%1$df, 4326)",
