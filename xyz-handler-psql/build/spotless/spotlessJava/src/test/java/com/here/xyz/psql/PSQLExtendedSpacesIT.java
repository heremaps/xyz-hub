...
public class PSQLExtendedSpacesIT extends PSQLAbstractIT {
  ...
  protected static void generateTestSpaces() throws Exception {
    /** Generate: BASE DELTA1 Extends BASE DELTA2 Extends DELTA1 */
          ...
          new ArrayList<Feature>() {
            {
              add(
                  FeatureGenerator.generateFeature(
                      new XyzNamespace().withSpace("foo").withCreatedAt(1517504700726L), null));
            }
          };
  ...
  protected static void checkIDXTable(int szenario, boolean baselayerSwitch) throws Exception {
    ...
    JSONObject base2_ref =
        new JSONObject("{\"searchableProperties\": {\"search_test_base2\": true}}");
    ;
    ...
    switch (szenario) {
      ...
      case 1:
        base1_ref =
            new JSONObject(
                "{\"sortableProperties\": [[\"sort_test\"]], \"searchableProperties\": {\"search_test\": true}}");
      ...
      case 2:
        base1_ref =
            new JSONObject(
                "{\"searchableProperties\": {\"search_test\": false,\"search_test2\": true}}");
        delta1_ref = base1_ref;
        delta2_ref = base1_ref;
        break;
      ...
      while (resultSet.next()) {
        ...
        switch (spaceId) {
          ...
          case DELTA1:
            if (!baselayerSwitch) {
              ...
              delta1_ref.put(
                  ...
                  ((JSONObject) delta1_ref.get("searchableProperties")).put("foo", true));
            }
          ...
          case DELTA2:
            ...
            delta2_ref.put(
                "searchableProperties",
                ((JSONObject) delta2_ref.get("searchableProperties")).put("foo", true));
  ...
  protected static void mockAutoIndexing() throws Exception {
    String q =
        "CREATE INDEX IF NOT EXISTS idx_base_test_foo_a"
            + " ON public."
            + BASE1
            + " USING btree"
