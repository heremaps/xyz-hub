...
public class PSQLHistoryFullIT extends PSQLAbstractIT {
  ...
  public void testFullHistoryTableWriting() throws Exception {
    ...
    try (final Connection connection = dataSource().getConnection()) {
      ...
      String sql =
          "SELECT * from foo_hst ORDER BY jsondata->'properties'->'foo', jsondata->'properties'->'@ns:com:here:xyz'->'deleted' desc";
      ...
      if (!resultSet.next()) {
        ...
        assertTrue(
            resultSet
                ...
                .contains("xyz_trigger_historywriter_full('" + maxVersionCount + "')"));
      }
    }
  }
}
