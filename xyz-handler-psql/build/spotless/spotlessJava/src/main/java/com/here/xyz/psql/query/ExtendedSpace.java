...
public abstract class ExtendedSpace<E extends Event, R extends XyzResponse>
    extends XyzQueryRunner<E, R> {
  ...
  protected static @NotNull Map<@NotNull String, @Nullable Object> getExtends(
      @NotNull Event event) {
  ...
  public static <E extends Event> String getExtendedTable(
      @NotNull E event, @NotNull PsqlHandler processor) {
    return null;
  }
